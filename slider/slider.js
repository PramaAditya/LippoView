	...
	jQuery.fn.QCslider = function(options_user) {
		...
		function SliderInit() {
			...
			if(!vel.hasClass("video")){
				...
				if(vtyp === "youtube"){
					vel.find('.include').html('<div id="'+vidp+'"></div>');
					...
					if(vmut === "true"){
						vel.find('.include').html('<video src="'+vurl+'" preload="auto" muted autoplay="true" poster="" id="'+vidp+'"></video>');
					}else{
						vel.find('.include').html('<video src="'+vurl+'" preload="auto" autoplay="true" poster="" id="'+vidp+'"></video>');
					}
					var dursecs;
		...
		function changePanel(id) {
			...
			if(pb.items.panel.eq(currentSlider).hasClass("video")){
				...
				if(vtyp === "youtube"){
					pb.items.panel.eq(currentSlider).find('.include').html('<div id="'+vidp+'"></div>');
				}else if(vtyp === "video"){
					pb.items.panel.eq(currentSlider).find('.include').html('');
				}
			}
